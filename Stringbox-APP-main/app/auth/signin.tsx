...
import { StyleSheet, TextInput, Pressable, View, Alert, ActivityIndicator, KeyboardAvoidingView, Platform, ScrollView } from 'react-native';
...
export default function SignInScreen() {
    ...
    const handleSignIn = async () => {
        ...
        if (error) {
            showAlert('Sign In Failed', error, 'error');
        } else {
                        ...
                        <View style={styles.form}>
                            ...
                            <Pressable
                                ...
                                <ThemedText style={styles.linkText}>
                                    Belum punya akun? <ThemedText style={styles.linkTextBold}>Sign Up</ThemedText>
                                </ThemedText>
                            </Pressable>
                        </View>
                    </View >
