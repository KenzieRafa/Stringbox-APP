...
export function simulatePythonExecution(code: string, problemId: string): ExecutionResult {
    let output = '';
...
function simulateChapter1(code: string, problem: number): string {
...
function simulateChapter2(code: string, problem: number): string {
    const lowerCode = code.toLowerCase();
...
function simulateChapter3(code: string, problem: number): string {
    const lowerCode = code.toLowerCase();
...
function simulateChapter4(code: string, problem: number): string {
    const lowerCode = code.toLowerCase();
...
function simulateChapter5(code: string, problem: number): string {
    const lowerCode = code.toLowerCase();
