...
interface RequirementsData {
    [key: number]: ChapterRequirements;
}

export function calculateScore(code: string, problemId: string): number {
    let score = 0;
...
export function getRequirements(chapter: number, problem: number): Requirement[] {
